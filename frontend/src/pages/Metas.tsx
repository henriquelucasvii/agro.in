...
// Intervalo de sondagem para manter a tela sincronizada com o backend.
// Se o backend passar a expor WebSocket/SSE para a rota /metas, troque
// esse polling por uma inscrição em tempo real (o restante do fluxo,
// que sempre grava direto na API a cada ação, continua igual.
